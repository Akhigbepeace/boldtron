...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-custom-gray py-normal">
      <div className="w-full max-w-[1200px] mx-auto px-pad max-md:px-normal flex flex-col md:flex-row items-center justify-between gap-normal md:gap-0">
        {/* Left: Logo */}
        ...
        {/* Categories Link */}
        <div className="flex items-center gap-intra cursor-pointer">
        ...
        <form 
          ...
          className="flex items-center w-full max-w-full md:max-w-[400px] my-0 md:mx-pad flex-1"
        >
        ...
        <div className="flex items-center gap-normal">
          ...
          <Link href="/cart" className="pl-normal cursor-pointer text-dark-olive hover:text-very-dark-olive transition-colors">
